...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/zero2075/updateTeam/main/shareCodes/ttysq.json')
  if (!res) {
    res = await getAuthorShareCode('https://raw.fastgit.org/zero2705/updateTeam/main/shareCodes/ttysq.json')
  }
  if (res) {
