...
!(async () => {
    ...
    let authorCode = []
    let res = await getAuthorShareCode('https://raw.githubusercontent.com/zero2051/updateTeam/main/shareCodes/tiger.json')
    if (!res) {
        res = await getAuthorShareCode('https://raw.fastgit.org/zero2051/updateTeam/main/shareCodes/tiger.json')
    }
    if (res) {
