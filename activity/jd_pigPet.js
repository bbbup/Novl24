...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/Aaron-lv1/updateTeam/master/shareCodes/pig.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/Aaron-lv1/updateTeam@master/shareCodes/pig.json'}).then((resp) => {}).catch((e) => console.log('刷新CDN异常', e));
    await $.wait(2000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/Aaron-lv1/updateTeam@master/shareCodes/pig.json')
  }
