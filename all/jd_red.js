...
async function showMsg() {
  if ($.errorMsg) return
  allMessage += `账号${$.index}：${$.nickName || $.UserName}${$.message}${$.index !== cookiesArr.length ? '\n\n' : ''}`;

  $.msg($.name, '', `${$.message}`, {"open-url": "https://bean.m.jd.com/beanDetail/index.action?resourceValue=bean", "media-url": "https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png"});
}
